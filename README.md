...
**Reverse a String** – Enter a string and the program will reverse it and print it out. [Solution in Python](https://github.com/Dineshkumar-Ponnusamy/Project/blob/main/Text/1.%20Reverse.py)
